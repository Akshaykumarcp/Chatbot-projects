...
def processRequest(req):
    ...
    if (intent=='product_selection'):
        ...
        email_sender.send_email_to_support(cust_name=cust_name,cust_contact=cust_phone,cust_email=cust_email,course_name=course_name,body=email_message_support)
